...
(function($, document) {
	...
	var domBuffer = '<div class="mui-dtpicker" data-type="datetime">\
		<div class="mui-dtpicker-header">\
			<button data-id="btn-cancel" class="mui-btn">Cancel</button>\
			<button data-id="btn-ok" class="mui-btn mui-btn-blue">OK</button>\
		</div>\
	...
	var DtPicker = $.DtPicker = $.Class.extend({
		...
		_create: function(options) {
			var self = this;
			options = options || {};
			options.labels = options.labels || ['Year', 'Mon', 'Day', 'Hour', 'Min'];
			options.buttons = options.buttons || ['Cancel', 'OK'];
